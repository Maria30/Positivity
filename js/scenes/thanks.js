class Thanks extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(config.width*.5, config.height*.50, "N'hésitez pas à vous abonner à notre page Instagram et à remplir notre formulaire de satisfaction !", {fontFamily: 'Normal', fontSize: '2.5em', color:'#444'}).setOrigin(0.5, 0.5)
